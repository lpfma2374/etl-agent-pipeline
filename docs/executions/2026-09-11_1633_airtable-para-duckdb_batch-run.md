# Batch-run 2026-09-11_1633 — airtable → duckdb (batch_size=50)

- **Data:** 2026-09-11T16:33:54+00:00
- **Lotes:** 1 executados | ✅ 1 | ❌ 0
- **Linhas entregues no destino (novas):** 9
- **Contagem cumulativa no destino:** {'References': 9}
- **Plano previsto:** {'raw_references': None}

| Lote | Estado | Linhas (raw) | Novas no destino | Erro |
|---|---|---|---|---|
| 1 | ✅ | {'raw_references': 9} | 9 | — |
