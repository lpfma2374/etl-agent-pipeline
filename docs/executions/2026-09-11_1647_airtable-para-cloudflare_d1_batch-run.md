# Batch-run 2026-09-11_1647 — airtable → cloudflare_d1 (batch_size=50)

- **Data:** 2026-09-11T16:47:00+00:00
...
n_pipeline.py", line 99, in cmd_load
    rows = loader.load(df, table)
           ^^^^^^^^^^^^^^^^^^^^^^
  File "/app/conversations/6aa334725d5b4135ae83ecb3/etl-agent-pipeline/extract/loaders/cloudflare_d1.py", line 79, in load
